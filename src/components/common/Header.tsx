...
export const Header = ({ title, description }: Props) => (
    <VStack
        ...
        alignItems='center'
        marginBottom={{ sm: '32px', lg: 0 }}
        width={{ sm: '328px', md: '727px', lg: '578px', xl: '898px' }}
        height={
            description
                ? { sm: '176px', md: '136px', lg: '308px' }
                : { sm: '80px', md: '80px', lg: '248px' }
        }
    ...
    >
        <Box display='flex' flexDirection='column'>
            <Heading
                ...
                textAlign='center'
                paddingBottom={
                    description ? { sm: '16px', md: '12px' } : { sm: '16px', lg: '32px' }
                }
            >
                {title}
            </Heading>
            {description && (
                <Text
                    ...
                    paddingBottom={description && { sm: '16px', md: '16px', lg: '32px' }}
                >
                    {description}
                </Text>
            )}
        </Box>
        <VStack spacing='16px' width='100%' alignItems='center' pb={{ sm: '32px', lg: '24px' }}>
            <HStack
                spacing='12px'
                width={{ sm: '328px', md: '448px', lg: '518px' }}
