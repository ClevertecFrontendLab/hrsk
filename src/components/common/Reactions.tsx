...
type ReactionsPropsType = {
    bookmarksCount?: Nullable<number>;
    ...
    return (
        <HStack spacing='8px'>
            <Box display='flex' alignItems='center' gap='6px'>
                {bookmarksCount !== null && bookmarksCount > 0 && (
                    <svg
                        width='12'
                        height='12'
                        viewBox='0 0 12 12'
                ...
                <Text lineHeight={1.5} fontWeight={600} fontSize={{ sm: '12px' }} color='lime.600'>
                    {bookmarksCount !== null && bookmarksCount > 0 && bookmarksCount}
                </Text>
            </Box>
            <Box display='flex' alignItems='center' gap='6px'>
                ...
                <Text lineHeight={1.5} fontWeight={600} fontSize={{ sm: '12px' }} color='lime.600'>
                    {likesCount !== null && likesCount > 0 && likesCount}
                </Text>
            </Box>
        </HStack>
    );
